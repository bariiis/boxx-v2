  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex flex-col gap-2 p-4 opacity-30 blur-[2px]">
        <div className="rounded-lg p-3" style={{ backgroundColor: COLORS.cardBorder }}>
          <span className="text-xs" style={{ color: COLORS.textMuted }}>
            Off track
          </span>
        </div>
      ...
      <div className="relative z-10 p-4 pt-20">
        ...
        >
          <div className="flex items-center gap-2 mb-1">
            <CheckCircle2 className="h-4 w-4" style={{ color: COLORS.accentGreenBright }} />
            <span className="text-sm font-medium" style={{ color: COLORS.accentGreenBright }}>
              On track
            </span>
          </div>
      ...
      <div className="space-y-2">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="flex gap-2">
            {[...Array(5 + ((i * 3) % 3))].map((_, j) => (
              <div
                key={j}
                className="h-1.5 rounded-full"
                style={{
                  backgroundColor: COLORS.cardBorder,
                  width: `${30 + ((i * 7 + j * 11) % 40)}px`,
                }}
              />
            ))}
          </div>
...
function Timeline() {
  return (
    ...
    >
      ...
      <div className="absolute text-xs font-medium" style={{ color: COLORS.textSecondary, top: "8%", left: "15%" }}>
        AUG 3
      </div>
      <div className="absolute text-xs font-medium" style={{ color: COLORS.textSecondary, top: "8%", left: "30%" }}>
        30
      </div>
      <div className="absolute text-sm font-medium" style={{ color: COLORS.textPrimary, top: "5%", left: "55%" }}>
        AUG 22
      </div>
      <div className="absolute text-xs" style={{ color: COLORS.textMuted, top: "12%", left: "65%" }}>
        24
      </div>
      <div className="absolute text-xs" style={{ color: COLORS.textMuted, top: "18%", left: "58%" }}>
        17
      </div>
      <div className="absolute text-xs" style={{ color: COLORS.textMuted, top: "24%", left: "52%" }}>
        10
      </div>
      <div className="absolute text-sm font-medium" style={{ color: COLORS.textPrimary, top: "5%", right: "12%" }}>
        SEP
      </div>
      ...
      {timelineItems.map((item, index) => (
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div className="h-0.5 flex-1 rounded-full" style={{ backgroundColor: item.color + "40" }} />
          ...
          <span className="mt-1 block text-xs font-medium" style={{ color: COLORS.textSecondary }}>
            {item.label}
          </span>
        </motion.div>
      ))}
    ...
    >
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="w-full text-base leading-relaxed" style={{ color: COLORS.textSecondary }}>
