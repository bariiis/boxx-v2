...
export function VtHowItWorksSection() {
  ...
  return (
    <section
      id="how-it-works"
      ref={sectionRef}
      className="relative py-24 lg:py-32 bg-[oklch(0.09_0.01_260)] text-[var(--lp-fg)] overflow-hidden"
    >
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-[var(--lp-bg)]/[0.02] blur-[100px] pointer-events-none" />
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            <div className={`transition-all duration-1000 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-12 opacity-0"}`}>
              <span className="inline-flex items-center gap-3 text-sm font-mono text-[var(--lp-fg)]/40 mb-8">
                <span className="w-12 h-px bg-[var(--lp-bg)]/20" />
                Process
              </span>
            </div>
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-[var(--lp-fg)]/30">Deploy.</span>
              <span className="block text-[var(--lp-fg)]/10">Scale.</span>
            </h2>
          </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                <span className={`text-4xl font-display transition-colors duration-300 ${
                  activeStep === index ? "text-[#eca8d6]" : "text-[var(--lp-fg)]/20"
                }`}>
                  {step.number}
                </span>
                <div className="flex-1 h-px bg-[var(--lp-bg)]/10 overflow-hidden">
                  {activeStep === index && (
              ...
              <span className="text-xl text-[var(--lp-fg)]/40 font-display block mb-6">
                {step.subtitle}
              </span>

              {/* Description */}
              <p className={`text-[var(--lp-fg)]/60 leading-relaxed transition-opacity duration-300 ${
