  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className="w-8 h-8 rounded-full shrink-0 mt-0.5 bg-zinc-700" />
...
export function SplitDashboardMockup() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mt-5 px-3">
          <div className="px-2 py-1 text-[10px] text-zinc-500 font-medium uppercase tracking-wider">Favorites</div>
          <div className="space-y-0.5 mt-1">
        ...
        <div className="mt-5 px-3 flex-1">
          <div className="px-2 py-1 text-[10px] text-zinc-500 font-medium uppercase tracking-wider">Your Teams</div>
          <div className="space-y-0.5 mt-1">
      ...
      >
        ...
        <div className="flex-1 overflow-auto">
          <InboxItem id="ENG-135" title="Refactor sonic crawler" subtitle="nan assigned you" time="2h" status="in-progress" active />
          <InboxItem id="LLM" title="LLM Chatbot" subtitle="New project update by raissa" time="1d" status="todo" isProject />
          <InboxItem id="ENG-159" title="Error uploading images via API" subtitle="SLA breached" time="2d" status="bug" />
          <InboxItem id="DES-498" title="Redesign users settings..." subtitle="karri mentioned you" time="4h" status="todo" />
          <InboxItem id="ENG-160" title="Holtzmann engine is broken" subtitle="You asked to be reminded" time="1w" status="bug" />
          <InboxItem title="Sign up flow experiments" subtitle="Added as project member" status="done" isProject />
          <InboxItem id="MKT-122" title="Design assets for marketing" subtitle="erin marked as Duplicate" time="1w" status="done" />
          <InboxItem title="Homepage v3" subtitle="New project update by paco" status="todo" isProject />
        </div>
      </motion.div>
        ...
        <div className="flex-1 p-5 overflow-auto">
          ...
          <div className="pt-4 border-t border-zinc-800/50">
            ...
            <div className="space-y-3">
              <ActivityItem name="nan" action="moved from" from="Backlog" to="In Progress" time="5 ay önce" />
              <ActivityItem name="alex" action="commented on" from="this issue" time="5 ay önce" />
            </div>
          </div>
        </div>
      </motion.div>
