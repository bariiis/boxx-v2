...
export function SplitAiSection({ demoteHeading = false }: { demoteHeading?: boolean }) {
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          >
            ...
            <span className="text-zinc-400 text-sm">Yapay zeka</span>
            ...
            >
              ...
              >
                ...
                <div className="bg-zinc-800/50 border border-zinc-700 rounded-t-xl px-5 py-4">
                  <span className="text-zinc-500 italic">Kime ata...</span>
                </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="border-t border-r border-b border-zinc-800/60 pt-12 pr-12 pb-16">
                <h3 className="text-zinc-200 font-medium text-xl mb-3">Kendi kendine işleyen ürün operasyonları</h3>
                <p className="text-zinc-500 text-base mb-8">
                  Rutin ve manuel görevler için AI yardımıyla ürün geliştirme akışlarınızı kolaylaştırın.
                </p>
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-zinc-600 text-sm w-20">Öneriler</span>
                  ...
                  <div className="bg-zinc-800/40 rounded-lg p-4 mt-4">
                    ...
                    <button
                      type="button"
                      className="w-full flex items-center justify-center gap-2 bg-zinc-700/50 hover:bg-zinc-600/50 text-zinc-300 text-sm py-2.5 rounded-md transition-colors"
                    >
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5 font-mono text-sm">
                  ...
                  <div className="bg-zinc-800/40 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-zinc-600">Ne isterseniz sorun</span>
                    </div>
