...
export function VtFeaturesSection() {
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-4 lg:gap-6">
          {/* Large feature card */}
          <div 
            className={`lg:col-span-12 relative bg-[var(--lp-bg)] border border-foreground/10 min-h-[500px] overflow-hidden group transition-all duration-700 flex ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
            onMouseEnter={() => setActiveFeature(0)}
          >
            {/* Left: text content */}
            <div className="relative flex-1 p-8 lg:p-12 bg-[var(--lp-bg)]">
            ...
            <div className="hidden lg:block relative w-[42%] shrink-0 overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[var(--lp-bg)] via-transparent to-transparent" />
            </div>
          </div>
        </div>
      </div>
