...
export function SplitLogoCloud() {
  return (
    <section className="relative z-20 py-24" style={{ backgroundColor: "#09090B" }}>
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-4xl text-center">
          ...
          >
            Dünyanın en iyi ürün ekiplerine güç veriyor.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Yeni nesil girişimlerden kurumsal devlere kadar.
          </motion.p>
